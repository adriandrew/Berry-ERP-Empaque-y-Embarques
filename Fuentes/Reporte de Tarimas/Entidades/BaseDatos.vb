...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteTarimas.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, EYELogicaReporteTarimas.Directorios.usuarioSql, EYELogicaReporteTarimas.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteTarimas.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, EYELogicaReporteTarimas.Directorios.usuarioSql, EYELogicaReporteTarimas.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionEmpaque()
        ...
        BaseDatos.ECadenaConexionEmpaque = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteTarimas.Directorios.instanciaSql, BaseDatos.ECadenaConexionEmpaque, EYELogicaReporteTarimas.Directorios.usuarioSql, EYELogicaReporteTarimas.Directorios.contrasenaSql)
