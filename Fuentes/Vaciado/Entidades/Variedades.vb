    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = "SELECT -1 AS Id, NULL AS Nombre FROM " & LogicaVaciado.Programas.prefijoBaseDatosEmpaque & "Variedades" & _
            " UNION SELECT Id, Nombre FROM " & LogicaVaciado.Programas.prefijoBaseDatosEmpaque & "Variedades " & _
            " WHERE 0=0 " & condicion
    ...
    Public Function ObtenerListado() As List(Of Variedades)
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = "SELECT IdProducto, Id, Nombre FROM " & LogicaVaciado.Programas.prefijoBaseDatosEmpaque & "Variedades WHERE 0=0 " & condicion
            comando.Parameters.AddWithValue("@idProducto", Me.EIdProducto)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionCatalogo.Open()
