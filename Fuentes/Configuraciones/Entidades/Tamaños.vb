    ...
    Public Function ObtenerListado() As DataTable
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = String.Format("SELECT IdProducto, Id, Nombre, Abreviatura FROM {0}Tamanos WHERE 0=0 {1}", EYELogicaConfiguraciones.Programas.prefijoBaseDatosEmpaque, condicion)
    ...
    Public Function ObtenerListadoReporteCatalogo() As DataTable
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = String.Format("SELECT Id, Nombre FROM {0}Tamanos WHERE 0=0 {1} ORDER BY Id ASC", EYELogicaConfiguraciones.Programas.prefijoBaseDatosEmpaque, condicion)
            comando.Parameters.AddWithValue("@idProducto", Me.EIdProducto)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionCatalogo.Open()
            Dim dataReader As SqlDataReader
