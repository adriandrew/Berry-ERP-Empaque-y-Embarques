    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            If Me.EId > 0 Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = "SELECT Id, Nombre FROM " & LogicaRecepcion.Programas.prefijoBaseDatosEmpaque & "Familias WHERE 0=0 " & condicion & " ORDER BY IdAlmacen, Id ASC"
    ...
    Public Function ObtenerListado() As List(Of Familias)
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = "SELECT IdAlmacen, Id, Nombre FROM " & LogicaRecepcion.Programas.prefijoBaseDatosEmpaque & "Familias WHERE 0=0 " & condicion
            comando.Parameters.AddWithValue("@idAlmacen", Me.EIdAlmacen)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionCatalogo.Open()
