...
Public Class Variedades
    ...
    Public Function ObtenerListadoReporteCatalogo() As DataTable
        ...
        Try
            ...
            End If
            comando.CommandText = String.Format("SELECT V.IdProducto, P.Nombre, V.Id, V.Nombre FROM {0}Variedades AS V " & _
            " LEFT JOIN {0}Productos AS P ON V.IdProducto = P.Id " & _
    ...
    Public Function ObtenerListado() As DataTable
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = String.Format("SELECT IdProducto, Id, Nombre FROM {0}Variedades WHERE 0=0 {1}", EYELogicaEmpaque.Programas.prefijoBaseDatosEmpaque, condicion)
            comando.Parameters.AddWithValue("@idProducto", Me.EIdProducto)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionCatalogo.Open()
            Dim lectorDatos As SqlDataReader
