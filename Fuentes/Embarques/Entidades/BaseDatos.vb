...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaEmbarques.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, EYELogicaEmbarques.Directorios.usuarioSql, EYELogicaEmbarques.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaEmbarques.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, EYELogicaEmbarques.Directorios.usuarioSql, EYELogicaEmbarques.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionEmpaque()
        ...
        BaseDatos.ECadenaConexionEmpaque = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaEmbarques.Directorios.instanciaSql, BaseDatos.ECadenaConexionEmpaque, EYELogicaEmbarques.Directorios.usuarioSql, EYELogicaEmbarques.Directorios.contrasenaSql)
