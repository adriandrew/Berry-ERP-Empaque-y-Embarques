...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteEmpaque.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, EYELogicaReporteEmpaque.Directorios.usuarioSql, EYELogicaReporteEmpaque.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteEmpaque.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, EYELogicaReporteEmpaque.Directorios.usuarioSql, EYELogicaReporteEmpaque.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionEmpaque()
        ...
        BaseDatos.ECadenaConexionEmpaque = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteEmpaque.Directorios.instanciaSql, BaseDatos.ECadenaConexionEmpaque, EYELogicaReporteEmpaque.Directorios.usuarioSql, EYELogicaReporteEmpaque.Directorios.contrasenaSql)
