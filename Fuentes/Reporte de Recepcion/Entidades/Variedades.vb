    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = "SELECT -1 AS Id, 'Todos' AS Nombre FROM " & EYELogicaReporteRecepcion.Programas.prefijoBaseDatosEmpaque & "Variedades " & _
            " UNION SELECT Id, Nombre FROM " & EYELogicaReporteRecepcion.Programas.prefijoBaseDatosEmpaque & "Variedades " & _
            " WHERE 0=0 " & condicion
    ...
    Public Function ObtenerListado() As List(Of Variedades)
        ...
        Try
            ...
            If Me.EId > 0 Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = "SELECT IdProducto, Id, Nombre FROM " & EYELogicaReporteRecepcion.Programas.prefijoBaseDatosEmpaque & "Variedades WHERE 0=0 " & condicion
            comando.Parameters.AddWithValue("@id", Me.EId)
            comando.Parameters.AddWithValue("@idProducto", Me.EIdProducto)
            BaseDatos.conexionCatalogo.Open()
