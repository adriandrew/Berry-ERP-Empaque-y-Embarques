...
Public Class Principal
    ...
    Public tarimas As New EYEEntidadesReporteTarimas.Tarimas()
    Public usuarios As New EYEEntidadesReporteTarimas.Usuarios()
    Public productores As New EYEEntidadesReporteTarimas.Productores()
    Public empresas As New EYEEntidadesReporteTarimas.Empresas()
...
#Region "Básicos"
    ...
    Private Sub ConfigurarConexiones()
        ...
        If (Me.esDesarrollo) Then
            EYELogicaReporteTarimas.Directorios.id = 1
            EYELogicaReporteTarimas.Directorios.instanciaSql = "BERRY1-DELL\SQLEXPRESS2008"
            EYELogicaReporteTarimas.Directorios.usuarioSql = "AdminBerry"
            EYELogicaReporteTarimas.Directorios.contrasenaSql = "@berry2017"
            pnlEncabezado.BackColor = Color.DarkRed
        Else
            EYELogicaReporteTarimas.Directorios.ObtenerParametros()
            EYELogicaReporteTarimas.Usuarios.ObtenerParametros()
        End If
        EYELogicaReporteTarimas.Programas.bdCatalogo = "Catalogo" & EYELogicaReporteTarimas.Directorios.id
        EYELogicaReporteTarimas.Programas.bdConfiguracion = "Configuracion" & EYELogicaReporteTarimas.Directorios.id
        EYELogicaReporteTarimas.Programas.bdEmpaque = "Empaque" & EYELogicaReporteTarimas.Directorios.id
        EYEEntidadesReporteTarimas.BaseDatos.ECadenaConexionCatalogo = EYELogicaReporteTarimas.Programas.bdCatalogo
        EYEEntidadesReporteTarimas.BaseDatos.ECadenaConexionConfiguracion = EYELogicaReporteTarimas.Programas.bdConfiguracion
        EYEEntidadesReporteTarimas.BaseDatos.ECadenaConexionEmpaque = EYELogicaReporteTarimas.Programas.bdEmpaque
        EYEEntidadesReporteTarimas.BaseDatos.AbrirConexionCatalogo()
        EYEEntidadesReporteTarimas.BaseDatos.AbrirConexionConfiguracion()
        EYEEntidadesReporteTarimas.BaseDatos.AbrirConexionEmpaque()
    ...
    Private Sub ConsultarInformacionUsuario()
        ...
        Dim lista As New List(Of EYEEntidadesReporteTarimas.Usuarios)
        usuarios.EId = EYELogicaReporteTarimas.Usuarios.id
        lista = usuarios.ObtenerListado()
        If (lista.Count > 0) Then
            EYELogicaReporteTarimas.Usuarios.id = lista(0).EId
            EYELogicaReporteTarimas.Usuarios.nombre = lista(0).ENombre
            EYELogicaReporteTarimas.Usuarios.contrasena = lista(0).EContrasena
            EYELogicaReporteTarimas.Usuarios.nivel = lista(0).ENivel
            EYELogicaReporteTarimas.Usuarios.accesoTotal = lista(0).EAccesoTotal
        End If
    ...
    Private Sub CargarPrefijoBaseDatosEmpaque()
        ...
        EYELogicaReporteTarimas.Programas.prefijoBaseDatosEmpaque = Me.prefijoBaseDatosEmpaque
    ...
    Private Sub CargarEncabezadosTitulos()
        ...
        lblEncabezadoEmpresa.Text = "Directorio: " & EYELogicaReporteTarimas.Directorios.nombre
        lblEncabezadoUsuario.Text = "Usuario: " & EYELogicaReporteTarimas.Usuarios.nombre
        Me.Text = "Programa:  " & Me.nombreEstePrograma & "              Directorio:  " & EYELogicaReporteTarimas.Directorios.nombre & "              Usuario:  " & EYELogicaReporteTarimas.Usuarios.nombre
    ...
    Private Sub AbrirPrograma(nombre As String, salir As Boolean)
        ...
        ejecutarProgramaPrincipal.Arguments = EYELogicaReporteTarimas.Directorios.id.ToString().Trim().Replace(" ", "|") & " " & EYELogicaReporteTarimas.Directorios.nombre.ToString().Trim().Replace(" ", "|") & " " & EYELogicaReporteTarimas.Directorios.descripcion.ToString().Trim().Replace(" ", "|") & " " & EYELogicaReporteTarimas.Directorios.rutaLogo.ToString().Trim().Replace(" ", "|") & " " & EYELogicaReporteTarimas.Directorios.esPredeterminado.ToString().Trim().Replace(" ", "|") & " " & EYELogicaReporteTarimas.Directorios.instanciaSql.ToString().Trim().Replace(" ", "|") & " " & EYELogicaReporteTarimas.Directorios.usuarioSql.ToString().Trim().Replace(" ", "|") & " " & EYELogicaReporteTarimas.Directorios.contrasenaSql.ToString().Trim().Replace(" ", "|") & " " & "Aquí terminan los de directorios, indice 9 ;)".Replace(" ", "|") & " " & EYELogicaReporteTarimas.Usuarios.id.ToString().Trim().Replace(" ", "|") & " " & "Aquí terminan los de usuario, indice 11 ;)".Replace(" ", "|")
        Try
...
#Region "Todos"
    ...
    Private Sub GenerarReporte()
        ...
        Else
            aplicaFecha = False
        End If
        datos = tarimas.ObtenerListadoReporte(aplicaFecha)
    ...
    Private Sub FormatearSpreadReporte(ByVal cantidadColumnas As Integer)
        ...
        spReporte.ActiveSheet.SheetName = "Reporte de Tarimas"
        spReporte.ActiveSheet.GrayAreaBackColor = Principal.colorSpreadAreaGris
        ...
        spReporte.ActiveSheet.Columns(numeracion).Tag = "tipoEmbarque" : numeracion += 1
        ...
        spReporte.ActiveSheet.Columns(numeracion).Tag = "idEmbarque" : numeracion += 1
        spReporte.ActiveSheet.Columns(numeracion).Tag = "fechaEmbarque" : numeracion += 1
        spReporte.ActiveSheet.Columns(numeracion).Tag = "horaEmbarque" : numeracion += 1
        ...
        spReporte.ActiveSheet.AddColumnHeaderSpanCell(0, spReporte.ActiveSheet.Columns("tipoEmbarque").Index, 2, 1)
        spReporte.ActiveSheet.ColumnHeader.Cells(0, spReporte.ActiveSheet.Columns("tipoEmbarque").Index).Value = "Tipo Embarque".ToUpper
        ...
        spReporte.ActiveSheet.ColumnHeader.Cells(0, spReporte.ActiveSheet.Columns("idLote").Index).Value = "L o t e".ToUpper
        ...
        spReporte.ActiveSheet.AddColumnHeaderSpanCell(0, spReporte.ActiveSheet.Columns("idEmbarque").Index, 1, 3)
        spReporte.ActiveSheet.ColumnHeader.Cells(0, spReporte.ActiveSheet.Columns("idEmbarque").Index).Value = "E m b a r q u e".ToUpper
        spReporte.ActiveSheet.ColumnHeader.Cells(1, spReporte.ActiveSheet.Columns("idEmbarque").Index).Value = "No.".ToUpper
        spReporte.ActiveSheet.ColumnHeader.Cells(1, spReporte.ActiveSheet.Columns("fechaEmbarque").Index).Value = "Fecha".ToUpper
        spReporte.ActiveSheet.ColumnHeader.Cells(1, spReporte.ActiveSheet.Columns("horaEmbarque").Index).Value = "Hora".ToUpper
        ...
        spReporte.ActiveSheet.Columns("tipoEmbarque").Width = 85
        ...
        spReporte.ActiveSheet.Columns("cantidadCajas").Width = 80
        spReporte.ActiveSheet.Columns("pesoCajas").Width = 70
        spReporte.ActiveSheet.Columns("idEmbarque").Width = 50
        spReporte.ActiveSheet.Columns("fechaEmbarque").Width = 80
        spReporte.ActiveSheet.Columns("horaEmbarque").Width = 60
