...
Public Class Clientes
    ...
    Public Sub Guardar()
        ...
        Try
            ...
            comando.CommandText = "INSERT INTO " & LogicaCatalogos.Programas.prefijoBaseDatosEmpaque & "Clientes (Id, Nombre, Rfc, Domicilio, Municipio, Estado, Telefono, Correo) VALUES (@id, @nombre, @rfc, @domicilio, @municipio, @estado,@telefono, @correo)"
    ...
    Public Sub Eliminar()
        ...
        Try
            ...
            End If
            comando.CommandText = "DELETE FROM " & LogicaCatalogos.Programas.prefijoBaseDatosEmpaque & "Clientes " & condicion
    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            Dim comando As New SqlCommand()
            comando.Connection = BaseDatos.conexionCatalogo
            comando.CommandText = "SELECT Id, Nombre, Rfc, Domicilio, Municipio, Estado, Telefono, Correo FROM " & LogicaCatalogos.Programas.prefijoBaseDatosEmpaque & "Clientes ORDER BY Id ASC"
            BaseDatos.conexionCatalogo.Open()
