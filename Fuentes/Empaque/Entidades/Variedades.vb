...
Public Class Variedades
    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            End If
            comando.CommandText = "SELECT V.IdProducto, P.Nombre, V.Id, V.Nombre FROM " & EYELogicaEmpaque.Programas.prefijoBaseDatosEmpaque & "Variedades AS V " & _
            " LEFT JOIN " & EYELogicaEmpaque.Programas.prefijoBaseDatosEmpaque & "Productos AS P ON V.IdProducto = P.Id " & _
            " WHERE 0=0 " & condicion
    ...
    Public Function ObtenerListado() As List(Of Variedades)
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = "SELECT IdProducto, Id, Nombre FROM " & EYELogicaEmpaque.Programas.prefijoBaseDatosEmpaque & "Variedades WHERE 0=0 " & condicion
            comando.Parameters.AddWithValue("@idProducto", Me.EIdProducto)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionCatalogo.Open()
