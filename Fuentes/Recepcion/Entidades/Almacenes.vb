...
Public Class Almacenes
    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            comando.CommandText = "SELECT Id, Nombre FROM " & LogicaRecepcion.Programas.prefijoBaseDatosEmpaque & "Almacenes " & _
            " UNION SELECT -1 AS Id, NULL AS Nombre FROM " & LogicaRecepcion.Programas.prefijoBaseDatosEmpaque & "Almacenes " & _
            " ORDER BY Id ASC"
    ...
    Public Function ObtenerListado() As List(Of Almacenes)
        ...
        Try
            ...
            End If
            comando.CommandText = "SELECT * FROM " & LogicaRecepcion.Programas.prefijoBaseDatosEmpaque & "Almacenes " & condicion
