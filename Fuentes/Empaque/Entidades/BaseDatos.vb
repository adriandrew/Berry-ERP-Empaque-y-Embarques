...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaEmpaque.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, EYELogicaEmpaque.Directorios.usuarioSql, EYELogicaEmpaque.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaEmpaque.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, EYELogicaEmpaque.Directorios.usuarioSql, EYELogicaEmpaque.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionEmpaque()
        ...
        BaseDatos.ECadenaConexionEmpaque = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaEmpaque.Directorios.instanciaSql, BaseDatos.ECadenaConexionEmpaque, EYELogicaEmpaque.Directorios.usuarioSql, EYELogicaEmpaque.Directorios.contrasenaSql)
