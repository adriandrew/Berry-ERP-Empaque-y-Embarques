...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteVaciado.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, EYELogicaReporteVaciado.Directorios.usuarioSql, EYELogicaReporteVaciado.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteVaciado.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, EYELogicaReporteVaciado.Directorios.usuarioSql, EYELogicaReporteVaciado.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionEmpaque()
        ...
        BaseDatos.ECadenaConexionEmpaque = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaReporteVaciado.Directorios.instanciaSql, BaseDatos.ECadenaConexionEmpaque, EYELogicaReporteVaciado.Directorios.usuarioSql, EYELogicaReporteVaciado.Directorios.contrasenaSql)
