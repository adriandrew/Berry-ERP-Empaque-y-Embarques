...
Public Class Lotes
    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            comando.CommandText = "SELECT Id, Nombre FROM " & EYELogicaEmpaque.Programas.prefijoBaseDatosEmpaque & "Lotes ORDER BY Id ASC"
    ...
    Public Function ObtenerListado() As List(Of Lotes)
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = "SELECT Id, Nombre, Hectareas, PesoCaja FROM " & EYELogicaEmpaque.Programas.prefijoBaseDatosEmpaque & "Lotes WHERE 0=0 " & condicion
