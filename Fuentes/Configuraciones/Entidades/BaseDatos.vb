...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaConfiguraciones.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, EYELogicaConfiguraciones.Directorios.usuarioSql, EYELogicaConfiguraciones.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaConfiguraciones.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, EYELogicaConfiguraciones.Directorios.usuarioSql, EYELogicaConfiguraciones.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionEmpaque()
        ...
        BaseDatos.ECadenaConexionEmpaque = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", EYELogicaConfiguraciones.Directorios.instanciaSql, BaseDatos.ECadenaConexionEmpaque, EYELogicaConfiguraciones.Directorios.usuarioSql, EYELogicaConfiguraciones.Directorios.contrasenaSql)
